...
export default function Communities() {
  ...
  return (
    <div className="p-4 bg-primary rounded-2xl relative">
      <img
        src="/landing-img/hero-background.png"
        alt="Hero"
        className="absolute inset-0 w-full h-full object-cover z-0 opacity-35 rotate-180"
      />
      <div className="relative z-10">
        ...
        <div className="flex flex-wrap gap-10 items-center justify-center py-20">
          ...
          >
            <img
              src={`${siteConfig.baseUrl === '/' ? '' : siteConfig.baseUrl}/landing-img/logo-white.svg`}
              alt="Fission"
              width={40}
              height={40}
            />
